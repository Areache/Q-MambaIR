...
class QuantMambaSISRGANModel(SRGANModel):
    """
    ...
    def __init__(self, opt):
        super(QuantMambaSISRGANModel, self).__init__(opt)
    ...
    def init_training_settings(self):
        ...
        if train_opt.get('kd_opt'):
            ...
            self.cri_kd = None
        super(QuantMambaSISRGANModel, self).init_training_settings()
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(QuantMambaSISRGANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
