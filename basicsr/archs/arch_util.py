...
from .BL_L_U_operator import Quant_linear as LinearOurs, Quant_conv as Conv2dOurs, Act_Quant as ActOurs, NoActQ
...
QConv2ds = {
    "Ours": Conv2dOurs,
    "QuantSR": Conv2dLSQ_soft,
}

QLinears = {
    "Ours": LinearOurs,
    "QuantSR": LinearLSQ_soft,
}
