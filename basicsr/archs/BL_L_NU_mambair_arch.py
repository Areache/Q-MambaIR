...
from .BL_L_NU_operator import in_out_linear, Quant_conv, Quant_linear, oneBK_N_r1 as Act_Quant, oneBK_N_r1 as Weight_Quant
...
class QuantBL_L_UN_MambaIR(nn.Module):
    ...
    def __init__(self,
                 ...
                 k_bits=32,
                 **kwargs):
        super(QuantBL_L_UN_MambaIR, self).__init__()
