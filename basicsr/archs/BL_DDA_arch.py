...
from .BL_DDA_operator import Weight_Quant, Act_Quant, Quant_conv, Quant_linear
...
class SS2D(nn.Module):
    def __init__(
        ...
        #! Quant_SSC
        # self.xs_q = Act_Quant(k_bits)
        # self.dts_q = Act_Quant(k_bits)
        # self.As_q = Act_Quant(k_bits)
        # self.Bs_q = Act_Quant(k_bits)
        # self.Cs_q = Act_Quant(k_bits) 
        # self.Ds_q = Act_Quant(k_bits)
        # self.dt_projs_bias_q = Act_Quant(k_bits)
...
class QuantBL_DDA_MambaIR(nn.Module):
    ...
    def __init__(self,
                 ...
                 k_bits=32,
                 **kwargs):
        super(QuantBL_DDA_MambaIR, self).__init__()
