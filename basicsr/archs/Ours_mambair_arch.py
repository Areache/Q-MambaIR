...
# from .Ours_operator import Ours_Weight_Quant as Weight_Quant, Act_Quant, Quant_conv, Quant_linear, Ours_SSM_Quant
from .Ours_operator import Weight_Quant, Act_Quant, Quant_conv, Quant_linear, Ours_SSM_beta_Quant as Ours_SSM_Quant
...
class SS2D(nn.Module):
    def __init__(
        ...
        #! Quant_SSC
        self.xs_q = Ours_SSM_Quant(k_bits)
        self.dts_q = Ours_SSM_Quant(k_bits)
        self.As_q = Ours_SSM_Quant(k_bits)
        self.Bs_q = Ours_SSM_Quant(k_bits)
        self.Cs_q = Ours_SSM_Quant(k_bits) 
        self.Ds_q = Ours_SSM_Quant(k_bits)
        self.dt_projs_bias_q = Ours_SSM_Quant(k_bits)
...
class Ours_MambaIR(nn.Module):
    ...
    def __init__(self,
                 ...
                 k_bits=32,
                 **kwargs):
        super(Ours_MambaIR, self).__init__()
