...
# from .BL_operator import Weight_Quant, Act_Quant, ssm_Act_Quant, Quant_conv, Quant_linear
# from .bl_old_operater import Act_Quant as Weight_Quant, Act_Quant, Act_Quant as ssm_Act_Quant, Quant_conv, Quant_linear
from .QuantSR_old_operator import ActOurs as Weight_Quant, ActOurs as Act_Quant, ActOurs as ssm_Act_Quant, Quant_conv, Quant_linear 
...
class QuantBL_MambaIR(nn.Module):
    ...
    def __init__(self,
                 ...
                 k_bits=32,
                 **kwargs):
        super(QuantBL_MambaIR, self).__init__()
