...
#         # plot_tensor_histogram(dts)
#         # import pdb; pdb.set_trace()
#         # plot_tensor_histogram(Cs)
...
#         # plot_tensor_3d(y[0], name = 'o_y0.png')
#         # plot_tensor_3d(y[1], name = 'o_y1.png')
#         # plot_tensor_3d(self.had(y)[0], name = 'o_y_had0.png')
#         # plot_tensor_3d(self.had(y)[1], name = 'o_y_had1.png')
#         # import pdb; pdb.set_trace()
#         y = self.out_norm(y)
#         y = y * F.silu(z)
#         out = self.out_proj(y)
