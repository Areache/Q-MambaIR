...
from .lsq_zz_operator import Weight_Quant, Act_Quant, Quant_conv, Quant_linear
...
class QuantSS_noloss_MambaIR(nn.Module):
    ...
    def __init__(self,
                 ...
                 k_bits=32,
                 **kwargs):
        super(QuantSS_noloss_MambaIR, self).__init__()
